...
""",
        ...
        + [
            FTL.Message(
                ...
                value=REPLACE(
                    password_manager, "Give up the memory game with Firefox Password Manager.", {"Firefox": TERM_REFERENCE("brand-name-firefox"),},
                ),
            ),
        ]
        + transforms_from(
        ...
        + [
            FTL.Message(
                ...
                value=REPLACE(
                    ...
                    {"%%": "%", "%(addons)s": VARIABLE_REFERENCE("addons"), "Firefox": TERM_REFERENCE("brand-name-firefox"),},
                ),
            ),
        ],
    )
