...
""",
        ...
        + [
            FTL.Message(
                ...
                value=REPLACE(quantum, "Welcome to Firefox", {"Firefox": TERM_REFERENCE("brand-name-firefox"),},),
            ),
            FTL.Message(
                id=FTL.Identifier("firstrun-take-firefox-with-you"),
                value=REPLACE(quantum, "Take Firefox with You", {"Firefox": TERM_REFERENCE("brand-name-firefox"),},),
            ),
            FTL.Message(
                id=FTL.Identifier("firstrun-already-using-firefox"),
                value=REPLACE(quantum, "Already using Firefox?", {"Firefox": TERM_REFERENCE("brand-name-firefox"),},),
            ),
        ]
        + transforms_from(
            """
